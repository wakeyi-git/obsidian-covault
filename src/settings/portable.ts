...
const DEVICE_KEYS: Array<keyof CoVaultSettings> = ["deviceId", "lastSeqByDb", "yjsSecretSet", "passwordSet", "validatePolicyByDb", "lastTombstoneSweepAt", "lastActiveTab", "handledPluginDeploys"];
